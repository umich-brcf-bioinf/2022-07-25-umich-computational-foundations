...
In this lesson we will work primarily with the `ggplot2` package to learn how to generate various plots and customizations.
...
gdp_exp_plot <- ggplot(data = gapminder, aes(x = gdpPercap, y = lifeExp))
...
ggplot(data = gapminder, aes(x = pop, y = lifeExp, color = continent)) +
    geom_point() +
    labs(x = "Population",
         y = "Life Expectancy")
```
